...
public class Tab3Activity extends Activity {
	...
	private class DataAdapter extends ArrayAdapter<Alcohol> {
		...
		public View getView(int position, View v, ViewGroup parent) {
			...
			if (data != null) {
				// 화면 출력
				TextView tv = (TextView) view.findViewById(R.id.alc_name);
				TextView tv2 = (TextView) view.findViewById(R.id.alc_bottle);
	...
	class Alcohol{
		...
		public void up(){
			...
			Button btn_up = (Button)findViewById(R.id.button_alcohol_up);
			btn_up.setOnClickListener(new ImageButton.OnClickListener(){

				@Override
				public void onClick(View v) {
					
					TextView total_alc = (TextView)findViewById(R.id.total_alc);
		...
		public void down(){
			if(bottle==0)
				...
				Button btn_down = (Button)findViewById(R.id.button_alcohol_down);
